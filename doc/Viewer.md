...
- scene histogram values use the current linear min/max controls, contribution/refinement distributions use those controls as log10 bounds, and all histograms default to `256` bins,

...
DEFAULT_DEBUG_CONTRIBUTION_RANGE = (0.0, 1.0)
DEFAULT_REFINEMENT_MIN_CONTRIBUTION = float(TRAINING_BUILD_ARG_DEFAULTS["refinement_min_contribution"])
...
DEFAULT_REFINEMENT_CONTRIBUTION_HISTORY_DECAY = 0.25
...
DEFAULT_LR_STAGE3_STEP = int(TRAINING_BUILD_ARG_DEFAULTS["lr_schedule_stage3_step"])

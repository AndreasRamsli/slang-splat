...
class GaussianRenderer:
    ...
    _DEFAULT_DEBUG_CONTRIBUTION_RANGE = (0.0, 1.0)
    ...
    def _raster_uniforms(self, background: np.ndarray, training_background_mode: int = 0, training_background_seed: int = 0) -> dict[str, object]:
        ...
        return {
            "g_Raster": {
                ...
                "debugRefinementGradientVarianceWeightExponent": float(self.debug_refinement_grad_variance_weight_exponent),
                "debugRefinementContributionWeightExponent": float(self.debug_refinement_contribution_weight_exponent),

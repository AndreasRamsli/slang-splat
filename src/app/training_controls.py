...
TRAINING_CLI_ARG_DEFS = (
    ...
    _cli_arg("--lr-mul-scale-stage1", dest="lr_scale_stage1_mul", build_arg="lr_scale_stage1_mul", type=float, default=_stage_default("lr_scale_stage1_mul", "lr_scale_mul")),
    _cli_arg("--lr-mul-scale-stage2", dest="lr_scale_stage2_mul", build_arg="lr_scale_stage2_mul", type=float, default=_stage_default("lr_scale_stage2_mul", "lr_scale_mul")),
    _cli_arg("--lr-mul-scale-stage3", dest="lr_scale_stage3_mul", build_arg="lr_scale_stage3_mul", type=float, default=_stage_default("lr_scale_stage3_mul", "lr_scale_mul")),
    _cli_arg("--lr-mul-scale-stage4", dest="lr_scale_stage4_mul", build_arg="lr_scale_stage4_mul", type=float, default=_stage_default("lr_scale_stage4_mul", "lr_scale_mul")),
    _cli_arg("--lr-mul-rot", dest="lr_mul_rot", build_arg="lr_rot_mul", type=float, default=_default("lr_rot_mul")),
    _cli_arg("--lr-mul-rot-stage1", dest="lr_rot_stage1_mul", build_arg="lr_rot_stage1_mul", type=float, default=_stage_default("lr_rot_stage1_mul", "lr_rot_mul")),
    _cli_arg("--lr-mul-rot-stage2", dest="lr_rot_stage2_mul", build_arg="lr_rot_stage2_mul", type=float, default=_stage_default("lr_rot_stage2_mul", "lr_rot_mul")),
    _cli_arg("--lr-mul-rot-stage3", dest="lr_rot_stage3_mul", build_arg="lr_rot_stage3_mul", type=float, default=_stage_default("lr_rot_stage3_mul", "lr_rot_mul")),
    _cli_arg("--lr-mul-rot-stage4", dest="lr_rot_stage4_mul", build_arg="lr_rot_stage4_mul", type=float, default=_stage_default("lr_rot_stage4_mul", "lr_rot_mul")),
    _cli_arg("--lr-mul-color", dest="lr_mul_color", build_arg="lr_color_mul", type=float, default=_default("lr_color_mul")),
    _cli_arg("--lr-mul-color-stage1", dest="lr_color_stage1_mul", build_arg="lr_color_stage1_mul", type=float, default=_stage_default("lr_color_stage1_mul", "lr_color_mul")),
    _cli_arg("--lr-mul-color-stage2", dest="lr_color_stage2_mul", build_arg="lr_color_stage2_mul", type=float, default=_stage_default("lr_color_stage2_mul", "lr_color_mul")),
    _cli_arg("--lr-mul-color-stage3", dest="lr_color_stage3_mul", build_arg="lr_color_stage3_mul", type=float, default=_stage_default("lr_color_stage3_mul", "lr_color_mul")),
    _cli_arg("--lr-mul-color-stage4", dest="lr_color_stage4_mul", build_arg="lr_color_stage4_mul", type=float, default=_stage_default("lr_color_stage4_mul", "lr_color_mul")),
    _cli_arg("--lr-mul-opacity", dest="lr_mul_opacity", build_arg="lr_opacity_mul", type=float, default=_default("lr_opacity_mul")),
    _cli_arg("--lr-mul-opacity-stage1", dest="lr_opacity_stage1_mul", build_arg="lr_opacity_stage1_mul", type=float, default=_stage_default("lr_opacity_stage1_mul", "lr_opacity_mul")),
    _cli_arg("--lr-mul-opacity-stage2", dest="lr_opacity_stage2_mul", build_arg="lr_opacity_stage2_mul", type=float, default=_stage_default("lr_opacity_stage2_mul", "lr_opacity_mul")),
    _cli_arg("--lr-mul-opacity-stage3", dest="lr_opacity_stage3_mul", build_arg="lr_opacity_stage3_mul", type=float, default=_stage_default("lr_opacity_stage3_mul", "lr_opacity_mul")),
    _cli_arg("--lr-mul-opacity-stage4", dest="lr_opacity_stage4_mul", build_arg="lr_opacity_stage4_mul", type=float, default=_stage_default("lr_opacity_stage4_mul", "lr_opacity_mul")),
    ...
    _cli_arg("--opacity-reg-stage1", dest="opacity_reg_stage1", build_arg="opacity_reg_weight_stage1", type=float, default=_default("opacity_reg_weight_stage1")),
    _cli_arg("--opacity-reg-stage2", dest="opacity_reg_stage2", build_arg="opacity_reg_weight_stage2", type=float, default=_default("opacity_reg_weight_stage2")),
    _cli_arg("--opacity-reg-stage3", dest="opacity_reg_stage3", build_arg="opacity_reg_weight_stage3", type=float, default=_default("opacity_reg_weight_stage3")),
    _cli_arg("--opacity-reg-stage4", dest="opacity_reg_stage4", build_arg="opacity_reg_weight_stage4", type=float, default=_default("opacity_reg_weight_stage4")),
    _cli_arg("--position-push-away-from-camera-step", dest="position_push_away_from_camera_step", build_arg="position_push_away_from_camera_step", type=float, default=_default("position_push_away_from_camera_step")),
    _cli_arg("--position-push-away-from-camera-step-stage1", dest="position_push_away_from_camera_step_stage1", build_arg="position_push_away_from_camera_step_stage1", type=float, default=_default("position_push_away_from_camera_step_stage1")),
    _cli_arg("--position-push-away-from-camera-step-stage2", dest="position_push_away_from_camera_step_stage2", build_arg="position_push_away_from_camera_step_stage2", type=float, default=_default("position_push_away_from_camera_step_stage2")),
    _cli_arg("--position-push-away-from-camera-step-stage3", dest="position_push_away_from_camera_step_stage3", build_arg="position_push_away_from_camera_step_stage3", type=float, default=_default("position_push_away_from_camera_step_stage3")),
    _cli_arg("--position-push-away-from-camera-step-stage4", dest="position_push_away_from_camera_step_stage4", build_arg="position_push_away_from_camera_step_stage4", type=float, default=_default("position_push_away_from_camera_step_stage4")),
    ...
    _cli_arg("--refinement-target-splat-ratio", dest="refinement_target_splat_ratio", build_arg="refinement_target_splat_ratio", type=float, default=_default("refinement_target_splat_ratio")),
    _cli_arg("--refinement-target-splat-ratio-stage1", dest="refinement_target_splat_ratio_stage1", build_arg="refinement_target_splat_ratio_stage1", type=float, default=_default("refinement_target_splat_ratio_stage1")),
    _cli_arg("--refinement-target-splat-ratio-stage2", dest="refinement_target_splat_ratio_stage2", build_arg="refinement_target_splat_ratio_stage2", type=float, default=_default("refinement_target_splat_ratio_stage2")),
    _cli_arg("--refinement-target-splat-ratio-stage3", dest="refinement_target_splat_ratio_stage3", build_arg="refinement_target_splat_ratio_stage3", type=float, default=_default("refinement_target_splat_ratio_stage3")),
    _cli_arg("--refinement-target-splat-ratio-stage4", dest="refinement_target_splat_ratio_stage4", build_arg="refinement_target_splat_ratio_stage4", type=float, default=_default("refinement_target_splat_ratio_stage4")),
    _cli_arg("--refinement-prune-lowest-contribution-ratio", dest="refinement_prune_lowest_contribution_ratio", build_arg="refinement_prune_lowest_contribution_ratio", type=float, default=_default("refinement_prune_lowest_contribution_ratio")),
    _cli_arg("--refinement-prune-lowest-contribution-ratio-stage1", dest="refinement_prune_lowest_contribution_ratio_stage1", build_arg="refinement_prune_lowest_contribution_ratio_stage1", type=float, default=_default("refinement_prune_lowest_contribution_ratio_stage1")),
    _cli_arg("--refinement-prune-lowest-contribution-ratio-stage2", dest="refinement_prune_lowest_contribution_ratio_stage2", build_arg="refinement_prune_lowest_contribution_ratio_stage2", type=float, default=_default("refinement_prune_lowest_contribution_ratio_stage2")),
    _cli_arg("--refinement-prune-lowest-contribution-ratio-stage3", dest="refinement_prune_lowest_contribution_ratio_stage3", build_arg="refinement_prune_lowest_contribution_ratio_stage3", type=float, default=_default("refinement_prune_lowest_contribution_ratio_stage3")),
    _cli_arg("--refinement-prune-lowest-contribution-ratio-stage4", dest="refinement_prune_lowest_contribution_ratio_stage4", build_arg="refinement_prune_lowest_contribution_ratio_stage4", type=float, default=_default("refinement_prune_lowest_contribution_ratio_stage4")),
    _cli_arg("--refinement-max-growth-per-step", dest="refinement_max_growth_per_step", build_arg="refinement_max_growth_per_step", type=float, default=_default("refinement_max_growth_per_step")),
    _cli_arg("--refinement-max-prune-per-step", dest="refinement_max_prune_per_step", build_arg="refinement_max_prune_per_step", type=float, default=_default("refinement_max_prune_per_step")),

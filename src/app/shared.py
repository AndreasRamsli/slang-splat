...
def build_training_params(
    *,
    ...
    resolved_sh_band_stage4 = clamp_int(3 if sh_band_stage4 is None and bool(use_sh_stage4) else (0 if sh_band_stage4 is None else sh_band_stage4), 0, 3)
    ...
    training = TrainingHyperParams(
        ...
        position_push_away_from_camera_step=clamp_float(position_push_away_from_camera_step, 0.0, 1e4),
        position_push_away_from_camera_step_stage1=clamp_float(position_push_away_from_camera_step_stage1, 0.0, 1e4),
        position_push_away_from_camera_step_stage2=clamp_float(position_push_away_from_camera_step_stage2, 0.0, 1e4),
        position_push_away_from_camera_step_stage3=clamp_float(position_push_away_from_camera_step_stage3, 0.0, 1e4),
        position_push_away_from_camera_step_stage4=clamp_float(position_push_away_from_camera_step_stage4, 0.0, 1e4),
        ...
        sorting_order_dithering_stage4=clamp_float(sorting_order_dithering_stage4, 0.0, 1.0),
        ...
        lr_pos_stage4_mul=max(float(lr_pos_stage4_mul), 0.0),
        lr_scale_mul=max(float(lr_scale_mul), 0.0),
        lr_scale_stage1_mul=max(float(lr_scale_stage1_mul), 0.0),
        lr_scale_stage2_mul=max(float(lr_scale_stage2_mul), 0.0),
        lr_scale_stage3_mul=max(float(lr_scale_stage3_mul), 0.0),
        lr_scale_stage4_mul=max(float(lr_scale_stage4_mul), 0.0),
        lr_rot_mul=max(float(lr_rot_mul), 0.0),
        lr_rot_stage1_mul=max(float(lr_rot_stage1_mul), 0.0),
        lr_rot_stage2_mul=max(float(lr_rot_stage2_mul), 0.0),
        lr_rot_stage3_mul=max(float(lr_rot_stage3_mul), 0.0),
        lr_rot_stage4_mul=max(float(lr_rot_stage4_mul), 0.0),
        lr_color_mul=max(float(lr_color_mul), 0.0),
        lr_color_stage1_mul=max(float(lr_color_stage1_mul), 0.0),
        lr_color_stage2_mul=max(float(lr_color_stage2_mul), 0.0),
        lr_color_stage3_mul=max(float(lr_color_stage3_mul), 0.0),
        lr_color_stage4_mul=max(float(lr_color_stage4_mul), 0.0),
        lr_opacity_mul=max(float(lr_opacity_mul), 0.0),
        lr_opacity_stage1_mul=max(float(lr_opacity_stage1_mul), 0.0),
        lr_opacity_stage2_mul=max(float(lr_opacity_stage2_mul), 0.0),
        lr_opacity_stage3_mul=max(float(lr_opacity_stage3_mul), 0.0),
        lr_opacity_stage4_mul=max(float(lr_opacity_stage4_mul), 0.0),
        ...
        lr_sh_stage4_mul=max(float(lr_sh_stage4_mul), 0.0),
        ...
        lr_schedule_stage3_lr=clamp_float(lr_schedule_stage3_lr, 1e-8, 1.0),
        ...
        lr_schedule_stage3_step=clamp_int(lr_schedule_stage3_step, 0, 1_000_000_000),
        ...
        refinement_target_splat_ratio=clamp_float(refinement_target_splat_ratio, 0.0, 1.0),
        refinement_target_splat_ratio_stage1=clamp_float(refinement_target_splat_ratio_stage1, 0.0, 1.0),
        refinement_target_splat_ratio_stage2=clamp_float(refinement_target_splat_ratio_stage2, 0.0, 1.0),
        refinement_target_splat_ratio_stage3=clamp_float(refinement_target_splat_ratio_stage3, 0.0, 1.0),
        refinement_target_splat_ratio_stage4=clamp_float(refinement_target_splat_ratio_stage4, 0.0, 1.0),
        refinement_max_growth_per_step=clamp_float(refinement_max_growth_per_step, 0.0, 10.0),
        refinement_max_prune_per_step=clamp_float(refinement_max_prune_per_step, 0.0, 1.0),
        refinement_alpha_cull_threshold=clamp_float(refinement_alpha_cull_threshold, 1e-8, 1.0),
        refinement_min_contribution=clamp_float(refinement_min_contribution, 0.0, 1_000_000_000.0),
        refinement_min_contribution_decay=clamp_float(refinement_min_contribution_decay, 0.0, 1.0),
        refinement_prune_lowest_contribution_ratio=clamp_float(refinement_prune_lowest_contribution_ratio, 0.0, 1.0),
        refinement_prune_lowest_contribution_ratio_stage1=clamp_float(refinement_prune_lowest_contribution_ratio_stage1, 0.0, 1.0),
        refinement_prune_lowest_contribution_ratio_stage2=clamp_float(refinement_prune_lowest_contribution_ratio_stage2, 0.0, 1.0),
        refinement_prune_lowest_contribution_ratio_stage3=clamp_float(refinement_prune_lowest_contribution_ratio_stage3, 0.0, 1.0),
        refinement_prune_lowest_contribution_ratio_stage4=clamp_float(refinement_prune_lowest_contribution_ratio_stage4, 0.0, 1.0),
        ...
        colorspace_mod_stage4=clamp_float(colorspace_mod_stage4, 1e-8, 8.0),
        ...
        ssim_weight_stage4=clamp_float(ssim_weight_stage4, 0.0, 1.0),
        ...
        max_visible_angle_deg_stage4=clamp_float(max_visible_angle_deg_stage4, 1e-8, 89.999),
        ...
        refinement_min_screen_radius_px_stage4=clamp_float(refinement_min_screen_radius_px_stage4, 0.0, 1e6),
        ...
        position_random_step_noise_stage4_lr=clamp_float(position_random_step_noise_stage4_lr, 0.0, 1e12),

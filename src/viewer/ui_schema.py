...
UI_TOOLTIPS = {
    ...
    **renderer_param_tooltips(),
    ...
    "refinement_viewed_fraction_zero_threshold": "Zero effective refinement contribution when viewed-fraction EMA drops below this value divided by the training camera count",

...
def test_build_training_params_preserves_numeric_ranges():
    params = build_training_params(
        ...
        refinement_contribution_area_exponent=-4.0,
        refinement_contribution_view_count_exponent=-5.0,
    ...
    assert params.training.lr_pos_stage4_mul == 456.0
